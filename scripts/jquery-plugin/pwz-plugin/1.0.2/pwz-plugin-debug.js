define("jquery-plugin/pwz-plugin/1.0.2/lazyload/1.0.0/lazyload-debug", [], function () {
...
* use $pdw.backTop();
******************************************/
define("jquery-plugin/pwz-plugin/1.0.2/backtop/1.0.0/backtop-debug", [], function () {
    return function (jQuery) {
...
define("jquery-plugin/pwz-plugin/1.0.2/dialog/1.0.0/dialog-debug", [], function (require) {
    return function (jQuery) {
    	(function($){
    		$.pdw = $.pdw || {};
	        $.pdw.Dialog = function () {
...
﻿define("jquery-plugin/pwz-plugin/1.0.2/cookie/1.2.0/cookie-debug", [], function () {
    return function (jQuery) {
        /*jshint eqnull:true */
        /*!
...
﻿define("jquery-plugin/pwz-plugin/1.0.2/indexSlide/1.0.0/indexSlide-debug", [], function () {
    return function (jQuery) {
        /******************************************
        * pdw.slidedown.js
        *
...
define("jquery-plugin/pwz-plugin/1.0.2/pwz-plugin-debug", ["./lazyload/1.0.0/lazyload-debug", "./backtop/1.0.0/backtop-debug", "./dialog/1.0.0/dialog-debug", "./cookie/1.2.0/cookie-debug", "./indexSlide/1.0.0/indexSlide-debug", "jquery-debug", "contentShown-debug"], function (require, exports) {
